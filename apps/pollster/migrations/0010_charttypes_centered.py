...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        t, _ = orm.ChartType.objects.all().get_or_create(shortname='google-map-centered', defaults={'description': 'Google Map (centered on user)'})
        t.save()

    def backwards(self, orm):
        orm.ChartType.objects.all().filter(shortname='google-map-centered').delete()
