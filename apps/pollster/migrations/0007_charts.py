...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Chart'
        db.create_table('pollster_chart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pollster.Survey'])),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pollster.ChartType'])),
            ('shortname', self.gf('django.db.models.fields.SlugField')(max_length=255, db_index=True)),
            ('chartwrapper', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('sqlfilter', self.gf('django.db.models.fields.CharField')(default='NONE', max_length=255)),
            ('sqlsource', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='DRAFT', max_length=255)),
        ))
        db.send_create_signal('pollster', ['Chart'])

        # Adding unique constraint on 'Chart', fields ['survey', 'shortname']
        db.create_unique('pollster_chart', ['survey_id', 'shortname'])

        # Adding model 'ChartType'
        db.create_table('pollster_charttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shortname', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255, db_index=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('pollster', ['ChartType'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Chart', fields ['survey', 'shortname']
        db.delete_unique('pollster_chart', ['survey_id', 'shortname'])

        # Deleting model 'Chart'
        db.delete_table('pollster_chart')

        # Deleting model 'ChartType'
        db.delete_table('pollster_charttype')
