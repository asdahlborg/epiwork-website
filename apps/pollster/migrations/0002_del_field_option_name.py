...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('pollster_option', 'name')


    def backwards(self, orm):
        
        # Adding field 'Option.name'
        db.add_column('pollster_option', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
