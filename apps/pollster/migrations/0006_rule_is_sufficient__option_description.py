...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rule.is_sufficient'
        db.add_column('pollster_rule', 'is_sufficient', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'TranslationOption.description'
        db.add_column('pollster_translationoption', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Option.description'
        db.add_column('pollster_option', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Rule.is_sufficient'
        db.delete_column('pollster_rule', 'is_sufficient')

        # Deleting field 'TranslationOption.description'
        db.delete_column('pollster_translationoption', 'description')

        # Deleting field 'Option.description'
        db.delete_column('pollster_option', 'description')
