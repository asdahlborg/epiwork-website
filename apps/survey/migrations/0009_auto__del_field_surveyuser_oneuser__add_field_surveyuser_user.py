...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('survey_surveyuser', 'oneuser_id', 'user_id')

    def backwards(self, orm):
        db.rename_column('survey_surveyuser', 'user_id', 'oneuser_id')
    ...
    models = {
        ...
        'survey.surveyuser': {
            ...
            'global_id': ('django.db.models.fields.CharField', [], {'default': "'0de07ffd-54a3-4d3d-8d98-6a61234b528f'", 'unique': 'True', 'max_length': '36'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
