...
class Migration(DataMigration):
    # see: http://south.aeracode.org/ticket/578

    def forwards(self, orm):
        if settings.DATABASES['default']['ENGINE'] == 'django.db.backends.sqlite3':
            db.execute("""UPDATE "survey_surveyuser" SET "deleted" = 0 WHERE "deleted" = 'False'""")
    ...
    models = {
        ...
        'survey.surveyuser': {
            ...
            'global_id': ('django.db.models.fields.CharField', [], {'default': "'d0b08618-be15-4422-9ca2-d8a7a7fe75fd'", 'unique': 'True', 'max_length': '36'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
