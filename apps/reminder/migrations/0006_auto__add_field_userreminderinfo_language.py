...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserReminderInfo.language'
        db.add_column('reminder_userreminderinfo', 'language', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserReminderInfo.language'
        db.delete_column('reminder_userreminderinfo', 'language')
