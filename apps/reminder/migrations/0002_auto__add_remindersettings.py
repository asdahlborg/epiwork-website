...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReminderSettings'
        db.create_table('reminder_remindersettings', (
            ...
            ('interval', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('reminder', ['ReminderSettings'])
