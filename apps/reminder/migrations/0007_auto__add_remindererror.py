...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReminderError'
        db.create_table('reminder_remindererror', (
        ...
        db.send_create_signal('reminder', ['ReminderError'])


    def backwards(self, orm):
        
        # Deleting model 'ReminderError'
        db.delete_table('reminder_remindererror')
    ...
    models = {
        ...
        'reminder.remindererror': {
            'Meta': {'object_name': 'ReminderError'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
