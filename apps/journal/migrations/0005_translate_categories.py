...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for language_code, language_name in settings.LANGUAGES:
            for category in orm['journal.Category'].objects.all():
                prefix = '' if language_code == settings.LANGUAGE_CODE else "TRANSLATE INTO " + language_code.upper() + " - "

                translation = orm['journal.CategoryTranslation'].objects.create(
                    language_code=language_code,
                    master=category,
                    t_title=prefix + category.title,
                )

    def backwards(self, orm):
        orm['journal.CategoryTranslation'].objects.all().delete()
