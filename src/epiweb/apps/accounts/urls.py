...
urlpatterns = patterns('',
    ...
    url(r'^password/change/done/$',
        ...
        {'template_name': 'registration/password/change_done.html'},
        name='auth_password_change_done'),
    url(r'^password/reset/$',
        auth_views.password_reset,
        {'template_name': 'registration/password/reset_form.html',
    ...
    url(r'^password/reset/done/$',
        ...
        {'template_name': 'registration/password/reset_done.html'},
